...
///////////////////////////////////////////////////////////////////////////
#include "Player.h"
#include "Arena.h" // we use some Arena public member functions
#include "globals.h" // we used UP 
#include <iostream> // we write to cout
#include <cstdlib> // we used exit
using namespace std;
...
{
	m_age++;
	m_arena->thePast().markIt(this->row(), this->col()); // notify the Past object about resulting position
}
...
void Player::move(int dir)
{
	...
	this->m_arena->thePast().markIt(this->row(), this->col()); // notify the Past object about resulting position
}
