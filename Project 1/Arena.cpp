...
///////////////////////////////////////////////////////////////////////////
#include "Arena.h"
#include "Past.h" // we defined a variable of type Past
#include "Robot.h" // we use the rows and cols functions from the Robot class
#include "Player.h" // we use the rows and cols functions from the Player class
#include "globals.h" // we used MAXROWS and MAXCOLS
#include <iostream> // we used cout
