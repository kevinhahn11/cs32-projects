...
///////////////////////////////////////////////////////////////////////////
#include "Game.h" // uses Game constructor
#include "Arena.h" // we use the Arena::addPlayer function
// #include "Robot.h"
#include "Player.h" // we use the Player::isDead function
#include "globals.h" // we use MAXROBOTS variable
#include <iostream> // used cout
#include <string>  
#include <cstdlib> // we use the rand() function and exit() code
#include <ctime>
using namespace std;
